...
/**
 * ADDED BY MO: COPY FROM io.appium.settings.AppiumIME
 * REQUIRED:
 * 1. Create a file such as res/xml/methods.xml
 * <?xml version="1.0" encoding="utf-8"?>
 * <input-method xmlns:android="http://schemas.android.com/apk/res/android" />
 *
 * 2. Add the follow element to the application of AndroidManifest.xml:
 *<service
 *  android:name="io.appium.uiautomator2.utils.ApptestAIUnicodeIME"
 *  android:enabled="true"
 *  android:label="ApptestAI IME"
